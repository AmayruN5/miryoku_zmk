...
#include "miryoku_layer_alternatives.h"
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_CUSTOM
    #elif defined (MIRYOKU_EXTRA_QWERTZ)
  ...
  #define MIRYOKU_LAYERMAPPING_BUTTON MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_NAV MIRYOKU_ALTERNATIVES_NAV_VI_CUSTOM
    #else
  ...
  #define MIRYOKU_LAYERMAPPING_MOUSE MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_MEDIA MIRYOKU_ALTERNATIVES_MEDIA_VI_CUSTOM
    #else
  ...
  #define MIRYOKU_LAYERMAPPING_MEDIA MIRYOKU_MAPPING
    ...
    #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_CUSTOM
  #endif
#endif
  ...
  #define MIRYOKU_LAYERMAPPING_NUM MIRYOKU_MAPPING
    ...
    #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_CUSTOM
  #endif
#endif
  ...
  #define MIRYOKU_LAYERMAPPING_SYM MIRYOKU_MAPPING
    ...
    #define MIRYOKU_LAYER_FUN MIRYOKU_ALTERNATIVES_FUN_CUSTOM
  #endif
#endif
...
#if !defined(MIRYOKU_LAYER_GAME_EX)
  #define MIRYOKU_LAYER_GAME_EX MIRYOKU_ALTERNATIVES_GAME_EX
#endif
#if !defined(MIRYOKU_LAYERMAPPING_GAME_EX)
  #define MIRYOKU_LAYERMAPPING_GAME_EX MIRYOKU_MAPPING
#endif
